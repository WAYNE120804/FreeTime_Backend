...
class User(Base):
    ...
    role_id = Column(Integer, nullable=True)  # Campo para relación futura con tabla Roles
    city_id = Column(Integer, nullable=True)  # Campo para relación futura con tabla City
